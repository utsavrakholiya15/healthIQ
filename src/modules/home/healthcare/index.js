...
import healthcareTop from '../../../assets/IMAGEs/healthcaretop.jpg';
import healthcareBottom from '../../../assets/IMAGEs/healthcarebottom.jpg';
            ...
            <div className="  font-poppins bg-image-1 bg-cover bg-no-repeat w-[100%] py-[120px]">
                ...
                "data-wow-offset="10">
                        ...
                        <div className="max-w-[500px]">
                            <img className=" w-[100%] rounded-[10px] object-cover" src={healthcareTop} />
                        </div>
                        {/* data  */}
                        <div>
                    ...
                    {/* bottom */}
                    <div className="flex flex-col-reverse items-center justify-center  gap-5 mt-[50px]  pb-[70px]
                xl:flex-row
                ...
                "data-wow-offset="10">
                        ...
                        {/* image  */}
                        <div className="max-w-[500px]">
                            <img className=" w-[100%] rounded-[10px] object-cover" src={healthcareBottom} />
                        </div>
